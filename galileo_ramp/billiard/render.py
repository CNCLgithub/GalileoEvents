""" BPY script that handles rendering logic for marble table
"""
import os
import sys
try:
...
def parser(args):
    ...
    p.add_argument('--render_mode', type = str, default = 'full',
                   choices = ['full', 'none'],
                   help = 'mode to render')
...
def main():
    ...
    scene = Scene(args.scene, args.trace,
                  theta = args.theta)
